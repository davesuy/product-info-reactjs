...
var class_name = "app-cm";
var class_count = document.getElementsByClassName(class_name).length;
...
for (var i = 0; i < class_count; i++) {
				...
				var AtlasComponent = function (_React$Component) {
								_inherits(AtlasComponent, _React$Component);

								function AtlasComponent() {
												_classCallCheck(this, AtlasComponent);

												var _this = _possibleConstructorReturn(this, (AtlasComponent.__proto__ || Object.getPrototypeOf(AtlasComponent)).call(this));
								...
								_createClass(AtlasComponent, [{
												...
												value: function componentDidMount() {
																...
																fetch("https://cmmarket.wpengine.com/wp-json/wp/v2/care_atlas?custom_item_id=" + class_cm, myInit).then(function (response) {
																				...
																				var atlas_title_output = _react2.default.createElement("div", { key: atlas_title, dangerouslySetInnerHTML: { __html: atlas_title } });

																				var atlas_content = response[0].acf.atlas_content;
																				var atlas_content_output = _react2.default.createElement("div", { key: atlas_content, dangerouslySetInnerHTML: { __html: atlas_content } });
																				...
																				var care_atlas_qr_code_output = _react2.default.createElement("div", { key: care_atlas_qr_code, dangerouslySetInnerHTML: { __html: care_atlas_qr_code } });

																				//console.log(response[0].acf.atlas_images);

																				var atlas_images = response[0].acf.atlas_images;

																				var atlas_image = _react2.default.createElement(
																								"div",
																								{ className: "care-atlas-img-con" },
																								_react2.default.createElement("img", { src: atlas_images[0].atlas_image, className: "aligncenter care-atlas-img" })
																				);
												...
												value: function render() {
																...
																return _react2.default.createElement(
																				"div",
																				{ className: "row care-atlas-popup-container" },
																				_react2.default.createElement(
																								"div",
																								{ className: "care-atlas-content-con  col-md-12" },
																								_react2.default.createElement(
																												"h1",
																												{ className: "atlas-title" },
																												this.state.atlas_title
																								),
																								_react2.default.createElement(
																												"h2",
																				...
																				_react2.default.createElement(
																								"div",
																								{ className: "no-atlas-bxslider col-md-12" },
																								this.state.atlas_image
																				),
																				_react2.default.createElement(
																								"div",
																								{ className: "care-atlas-popup-sidebar col-md-12" },
																								_react2.default.createElement(
																												"div",
																												{ className: "row" },
																												_react2.default.createElement(
																																...
																																_react2.default.createElement(
																																				...
																																				_react2.default.createElement(
																																								...
																																								" ",
																																								this.state.experience_required
																																				),
																																				_react2.default.createElement(
																																								"p",
																																								null,
																												...
																												_react2.default.createElement(
																																"div",
																																{ className: "qr-code-con col-md-3" },
				...
				_reactDom2.default.render(_react2.default.createElement(AtlasComponent, null), document.getElementsByClassName(class_name)[i].querySelector(".app-embedd"));
}
